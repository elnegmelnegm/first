...
with col1:
  ...
  standard_values_st = []
  for i in range(5):
    value = st.number_input("Area of standard", key="standard_value_st{}".format(i))
...
with col2:
  ...
  standard_values_s = []
  for i in range(3):
    standard_values_s.append(st.number_input("Area of sample", key="standard_value_sample_s{}".format(i)))
...
with st.container():
  ...
  standard_purity = float(st.number_input("Purity of standard (%)", key="purity"))
